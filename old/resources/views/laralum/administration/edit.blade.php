    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::administration::update', ['member' => $member->id]) }}" enctype="multipart/form-data">
                    <div class="ui very padded segment">
                        ...
                        <div class="field">
                            ...
                            <input type="text"  name="designation" placeholder="Position..." value="{{$member->designation}}">
                        </div>

                        <div class="field">
                            <label>Department</label>
                            <input type="text"  name="department" placeholder="Department..." value="{{$member->department}}">
                        </div>
                        ...
                        <div class="field">
                            ...
                            <input type="text"  name="primary_email" placeholder="Primary Email..." value="{{$member->primary_email}}">
                        </div>

                        <div class="field">
                            <label>Other Emails</label>
                            <input type="text"  name="other_emails" placeholder="Other Emails..." value="{{$member->other_emails}}">
                        </div>

                        <div class="field">
                            <label>Website Link</label>
                            <input type="text"  name="website_link" placeholder="Website Link..." value="{{$member->website_link}}">
                        </div>
                        ...
                        <div class="field">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="path" readonly style="border-radius: 0" value="{{$member->image_url}}">
                            </div>
                            <br/>
                            <img id="img-upload" @if($member->image_url) src="{{ asset("storage/image/administration/$member->image_url") }}" @else src="{{ asset('storage/image/no-image.png') }}" @endif/>
                        </div>
