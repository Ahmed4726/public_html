...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Administrative Member Create</div>
    </div>
@endsection
@section('title', 'Administrative Member Create')
@section('icon', "plus")
@section('subtitle', 'Administrative Member Create')
@section('content')
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::administration::store') }}" enctype="multipart/form-data">
                    <div class="ui very padded segment">
                        ...
                        <div class="field">
                            <label>Address</label>
                            <textarea class="tinymce" name="address" id="address"></textarea>
                        </div>
