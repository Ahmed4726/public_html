...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Department Create</div>
    </div>
@endsection
@section('title', 'Department Create')
@section('icon', "plus")
@section('subtitle', 'Department Create')
@section('content')
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::department::store') }}" enctype="multipart/form-data">
                    <div class="ui very padded segment">
                        ...
                        <div class="field">
                            ...
                            <input type="text"  name="contact_mobile_number" placeholder="Contact Moblie Number...">
                        </div>
                        ...
                        <div class="field">
                            ...
                            <textarea class="tinymce" name="message_from_chairman" id="message_from_chairman"></textarea>
                        </div>
