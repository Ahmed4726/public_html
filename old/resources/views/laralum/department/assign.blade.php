...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Department Chairman Assign</div>
    </div>
@endsection
@section('title', 'Department Chairman Assign')
@section('icon', "check")
...
@section('content')
    ...
    <div class="ui doubling stackable grid container" id="vue-app" v-cloak>
        ...
        <div class="row">
            <div class="two wide column"></div>
            <div class="twelve wide column">
                <form class="ui form" method="POST" action="{{ route('Laralum::department::assign::save', ['department' => $department->id]) }}" enctype="multipart/form-data">
