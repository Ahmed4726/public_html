...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">User Type Edit</div>
    </div>
@endsection
@section('title', 'User Type Edit')
@section('icon', "edit")
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::users::type::update', ['type' => $type->id]) }}">
