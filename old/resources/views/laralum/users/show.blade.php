...
<div class="ui doubling stackable grid container">
    ...
    <div class="eight wide column">
        <div class="ui segment">
            <div class="ui blue ribbon label">{{ trans('laralum.avatar') }}</div>
            <br><br>
            <center>
                <img class="ui small circular image" src="{{ $user->avatar(150) }}">
            </center>
            <br><br>
            <div class="ui blue ribbon label">{{ trans('laralum.information') }}</div>
            <br><br>
            <center>
            ...
            <br><br>
            <div class="ui blue ribbon label">{{ trans('laralum.roles') }}</div>
            <br><br>
