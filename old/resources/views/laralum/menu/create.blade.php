...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Menu Create</div>
    </div>
@endsection
@section('title', 'Menu Create')
@section('icon', "plus")
@section('subtitle', 'Menu Create')
@section('content')
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::menu::store') }}" enctype="multipart/form-data">
