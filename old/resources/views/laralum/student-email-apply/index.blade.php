...
<div class="ui one column doubling stackable grid container">
    ...
    <div class="column">
        ...
        @if(isset($uri)) <a class="float-right"
            href="{{route("Laralum::$uri::teacher::list", [$uri => $uriValue])}}">Clear
            Search</a>
        @else <a class="float-right" href="{{route('Laralum::student-email-apply::list')}}">Clear Search</a> @endif
    </div>
            ...
            <table class="ui selectable padded compact striped celled small table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ optional($email->program)->name }}</td>
                        <td class="flex">
                            @if ($email->isPending())
