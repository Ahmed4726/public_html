                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            @if($program && $program->center_id && $program->center()->exists()) <li class="breadcrumb-item"><a href="{{route('Frontend::center::view', ['slug' => $program->center->slug])}}">{{$program->center->name}}</a></li>
