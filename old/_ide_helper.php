 ...
 * Generated for Laravel 7.10.3 on 2020-07-28 10:22:53.
 *
...
namespace App\Utilitys\Facades { 
    ...
    class Helper {
         ...
         * @static 
         */ 
        public static function userNameGenerator($name, $session, $counter = 1, $increment = 2)
        {
                        /** @var \App\Utilitys\Helper $instance */
                        $instance->userNameGenerator($name, $session, $counter, $increment);
        }
