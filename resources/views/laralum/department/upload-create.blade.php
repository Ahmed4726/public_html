...
@endsection
@section('title', 'Department Upload New File')
@section('icon', "upload")
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            <div class="sixteen wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::department::upload::save', ['department' => $department->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="ui segment">
                            <div class="field">
                                <div class="ui toggle checkbox">
                                    <input type="checkbox" name="listing_enabled" tabindex="0" class="hidden" checked="checked">
