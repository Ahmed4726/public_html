...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Centers / Offices Director Assign</div>
    </div>
@endsection
@section('title', 'Centers / Offices Director Assign')
@section('icon', "check")
@section('subtitle', $center->name)
@section('content')

    <div class="ui one column doubling stackable grid container" id="vue-app" v-cloak>
        ...
        <div class="row">
            <div class="two wide column"></div>
            <div class="twelve wide column">
                <form class="ui form" method="POST" action="{{ route('Laralum::center::assign::save', ['center' => $center->id]) }}" enctype="multipart/form-data">
