...
@section('breadcrumb')
    <div class="ui breadcrumb">
        <a class="section" href="{{ route('Laralum::center::type::list') }}">Centers / Offices Type List</a>
        <i class="right angle icon divider"></i>
        <div class="active section">Centers / Offices Type Edit</div>
    </div>
@endsection
@section('title', 'Centers / Offices Type Edit')
@section('icon', "edit")
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::center::type::update', ['type' => $type->id]) }}">
