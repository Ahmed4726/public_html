...
<div class="ui breadcrumb">
    ...
    <div class="active section">Centers / Offices Edit</div>
</div>
@endsection
    ...
    <div class="row">
        ...
        <div class="twelve wide column" id="vue-app">
            <form class="ui form" method="POST"
                action="{{ route('Laralum::center::update', ['center' => $center->id]) }}"
                ...
                <div class="ui very padded segment">
                    ...
                    @can('ADMIN')<div class="field required">
                        <label>Name</label>
                        <input type="text" name="name" placeholder="Name..." required value="{{ $center->name }}">
                    </div>@endcan

                    <div class="field">
                        <label>Name in Bangla</label>
                        <input type="text" name="name_ben" placeholder="Name in Bangla..."
                            value="{{ $center->name_ben }}">
                    </div>
                    ...
                    <div class="field required">
                        ...
                        <select name="type_id" required>
                            ...
                            <option @if($center->type_id == $type->id) selected @endif
                    ...
                    <div class="field required">
                        ...
                        <input type="text" name="slug" placeholder="Slug..." value="{{ $center->slug }}" required>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="website_link" placeholder="Website URL..."
                            value="{{ $center->website_link }}">
                    </div>

                    <div class="field">
                        <label>Description</label>
                        <textarea class="tinymce" name="description"
                            id="description">{{ $center->description }}</textarea>
                    </div>

                    <div class="field">
                        <label>Director Label</label>
                        <input type="text" name="director_label" placeholder="Director Label..."
                            value="{{ $center->director_label }}">
                    </div>

                    <div class="field">
                        <label>Message From Director Label</label>
                        <input type="text" name="director_msg_label" placeholder="Message From Director Label..."
                            value="{{ $center->director_msg_label }}">
                    </div>

                    <div class="field">
                        <label>Message From Director</label>
                        <textarea class="tinymce" name="message_from_director"
                            id="message_from_director">{{ $center->message_from_director }}</textarea>
                    </div>

                    <div class="field">
                        <label>EX-Directors</label>
                        <textarea class="tinymce" name="ex_directors"
                            id="ex_directors">{{ $center->ex_directors }}</textarea>
                    </div>

                    @can('ADMIN')
                        <div class="field">
                            <label>Configuration</label>
                            <textarea name="config">{{stripcslashes(\Laralum::arrayToConfigFormat($center->config))}}</textarea>
                        </div>
                    @endcan
                    ...
                    <div class="field">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="path"
                                value="{{ $center->director_image_url }}" readonly style="border-radius: 0">
                        </div>
                        <br />
                        <img id="img-upload" @if($center->director_image_url)
                        src='{{ asset("storage/image/center/$center->director_image_url") }}' @else
