...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Research Create</div>
    </div>
@endsection
@section('title', 'Research Create')
@section('icon', "plus")
@section('subtitle', 'Research Create')
@section('content')
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::research::store') }}" enctype="multipart/form-data">
                    <div class="ui very padded segment">
                        ...
                        <div class="field">
                            ...
                            <textarea class="tinymce" name="message_from_editor" id="message_from_editor"></textarea>
                        </div>
