            ...
            <form class="ui form" method="POST"
                ...
                <div class="ui very padded segment">
                    ...
                    <div class="field required">
                        ...
                        <select name="program_id" v-model="program_id" @change="programUpdated" required>
                    ...
                    <div class="field" v-if="semester">
                        <label>Semester</label>
                        <input type="text" name="semester" placeholder="Semester..."
                            value="{{old('semester', $email->semester)}}">
                    </div>
...
<script type="text/javascript">
    new Vue({
        ...
        data : {
            departments : {},
            faculty_id : "",
            program_id :"{{old('program_id', $email->program_id)}}",
