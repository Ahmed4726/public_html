        ...
        <div class="seven wide column">
            <div class="ui card full-width">
                ...
                <div class="content">
                    ...
                    @if ($email->semester)
                    <div class="flex">
                        <label class="text-right c-header">Semester</label>
                        <span class="c-value text-left">{{$email->semester}}</span>
                    </div>
                    @endif
                    ...
                    <div class="flex">
                        ...
                        <span class="c-value text-left">{{optional($email->updated_at)->format('Y-m-d h:i:s a')}}</span>
                    </div>
                    @endif
                </div>
