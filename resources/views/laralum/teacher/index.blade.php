...
<div class="ui one column doubling stackable grid container" id="teacherList">
    @can('DEPARTMENT')
    <div class="column">
        <form>
                    ...
                    <tr data-item="{{$teacher->id}}">
                        ...
                        <td>
                            ...
                            <label class="ui label 
                                @if($teacher->status == 1) basic 
                                @elseif($teacher->status == 2) black 
                                @elseif($teacher->status == 3) orange 
                                @elseif($teacher->status == 4) yellow 
                                @elseif($teacher->isPending()) teal 
                                @elseif($teacher->isRejected()) grey 
                                @endif">
                        ...
                        <td>
                            ...
                            @if ($teacher->is_applied && auth()->user()->can('ADMIN'))
                            <div class="ui blue top icon right floating pointing dropdown button">
                                ...
                                <div class="menu">
                                    ...
                                    <a target="_blank"
                                        href='{{route("Laralum::teacher::detail", ['teacher' => $teacher->id])}}'
                                        class="item">
                                    ...
                                    <a href='#' style="color: red" class="item"
                                        @click.prevent="rejectModal('/{{$teacher->id}}/mark-rejected')">
                                    ...
                                    <a href="{{route('Laralum::teacher::mark-activate', ['teacher' => $teacher->id])}}"
                                        class="item">
                                        <i class="check icon"></i>Mark Activate
                                    </a>
                                    @endif
                                    @endif
                                    ...
                                    {{-- @if ($teacher->isActive()) --}}
                                    <a target="_blank"
                                        href="{{route('Laralum::teacher::pdf', ['teacher' => $teacher->id])}}"
                                        class="item">
