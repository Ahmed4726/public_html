...
@section('breadcrumb')
    <div class="ui breadcrumb">
        <div class="active section">Officers / Staffs Type</div>
    </div>
@endsection
@section('title', 'Officers / Staffs Type')
@section('icon', "list")
@section('subtitle', 'Officers / Staffs Type')
@section('content')
    ...
    <div class="ui doubling stackable grid container">
                ...
                <table class="ui selectable striped celled small table">
                    ...
                    @foreach($types as $type)
                        <tr>
                            ...
                            <td>
                                <a href='{{ route('Laralum::officer::type::edit', ['type' => $type->id]) }}' class="item">
        ...
        <div class="row">
            <div class="sixteen wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::officer::type::create') }}">
