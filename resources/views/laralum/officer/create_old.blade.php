...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Officers / Staff Create</div>
    </div>
@endsection
@section('title', 'Officers / Staff Create')
@section('icon', "plus")
@section('subtitle', 'Officers / Staff Create')
@section('content')
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::officer::store') }}" enctype="multipart/form-data">
