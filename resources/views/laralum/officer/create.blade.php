...
<div class="ui breadcrumb">
    ...
    <div class="active section">Employee Create</div>
</div>
@endsection
@section('title', 'Employee Create')
@section('icon', "plus")
@section('subtitle', 'Employee Create')
@section('content')
...
<div class="ui doubling stackable grid container">
    <div class="row">
        ...
        <div class="twelve wide column" id="vue-app">
            <form class="ui form" method="POST" action="{{ route('Laralum::officer::store') }}"
                ...
                <div class="ui very padded segment">
                    ...
                    @if($uri == 'center') <input type="hidden" name="center_id" value="{{$uriValue}}">
                    @elseif($uri == 'department')<input type="hidden" name="department_id" value="{{$uriValue}}">
                    @endif
