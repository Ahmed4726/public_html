...
<div class="ui breadcrumb">
    <a class="section" href="{{ route("Laralum::$uri::officer::list", [$uri => $uriValue]) }}">Employee List</a>
    <i class="right angle icon divider"></i>
    <div class="active section">Employee Edit</div>
</div>
@endsection
    ...
    <div class="row">
        ...
        <div class="twelve wide column" id="vue-app">
            <form class="ui form" method="POST"
                action="{{ route('Laralum::officer::update', ['officer' => $officer->id]) }}"
                ...
                <div class="ui very padded segment">
                    ...
                    <div class="field required">
                        ...
                        <select name="status" required>
                            ...
                            <option @if($officer->status == $status->id) selected @endif
                    ...
                    <div class="field required">
                        ...
                        <select name="type_id" @change="eventChange($event)" required>
                            ...
                            <option @if($officer->type_id == $type->id) selected @endif
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="name_ben" placeholder="Name in Bangla..."
                            value="{{$officer->name_ben}}">
                    </div>

                    <div class="field">
                        <label>Email</label>
                        <input type="text" name="email" placeholder="Email..." value="{{$officer->email}}">
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="path" value="{{$officer->image_url}}" readonly
                                style="border-radius: 0">
                        </div>
                        <br />
                        <img id="img-upload" @if($officer->image_url)
                        src='{{asset("storage/image/officer/$officer->image_url")}}' @else
