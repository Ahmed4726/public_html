...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Hall Create</div>
    </div>
@endsection
@section('title', 'Hall Create')
@section('icon', "plus")
@section('subtitle', 'Hall Create')
@section('content')
    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{ route('Laralum::hall::store') }}" enctype="multipart/form-data">
                    <div class="ui very padded segment">
                        ...
                        <div class="field">
                            ...
                            <input type="text"  name="short_name_ben" placeholder="Short Name in Bangla...">
                        </div>
                        ...
                        <div class="field">
                            ...
                            <input type="text"  name="provost_label" placeholder="Provost Label...">
                        </div>

                        <div class="field">
                            <label>Message From Provost Label</label>
                            <input type="text"  name="message_from_provost_label" placeholder="Message From Provost Label...">
                        </div>

                        <div class="field">
                            <label>Message From Provost</label>
                            <textarea class="tinymce" name="message_from_provost" id="message_from_provost"></textarea>
                        </div>
                        ...
                        <div class="ui calendar field" id="establishDate">
                            ...
                            <div class="ui input left icon">
                                ...
                                <input type="text" name="dob" id="datePicker" placeholder="Established Date.." autocomplete="off">
                            </div>
                        </div>
