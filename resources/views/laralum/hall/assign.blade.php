...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <div class="active section">Hall Provost Assign</div>
    </div>
@endsection
@section('title', 'Hall Provost Assign')
@section('icon', "edit")
...
@section('content')
    ...
    <div class="ui doubling stackable grid container" id="vue-app" v-cloak>
        ...
        <div class="row">
            <div class="two wide column"></div>
            <div class="twelve wide column">
                <form class="ui form" method="POST" action="{{ route('Laralum::hall::assign::save', ['hall' => $hall->id]) }}" enctype="multipart/form-data">
