    ...
    <div class="ui doubling stackable grid container">
        <div class="row">
            ...
            <div class="twelve wide column" id="vue-app">
                <form class="ui form" method="POST" action="{{route('Laralum::faculty::facultyEventstore')}}" enctype="multipart/form-data">
                    <div class="ui very padded segment">
                        ...
                        <div class="ui calendar field" id="date">
                            ...
                            <div class="ui input left icon">
                                ...
                                <input type="text" name="publish_date" id="datePicker" placeholder="Publish Date.." autocomplete="on" value="{{date('M d, Y')}}">
                            </div>
                        </div>

                        @if(isset($uri) && $uri == 'faculty')
                        <input type="hidden" name="faculty_id" value="{{$uriValue}}">
                         @endif

                        <div class="inline field" v-if="maxSize">
                            Max Upload Size : <label v-text="maxSize"></label> 500 kb
                        </div>

                        <div class="inline field" v-if="width">
                            Width : <label v-text="width"> 800</label> px
                        </div>

                        <div class="inline field" v-if="height">
                            Height : <label v-text="height">900</label> px
                        </div>


                        <div class="field">
                            <label>Upload (Image or PDF File)</label>
