                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item @if($key == '0') active @endif">
                        @if($image->external_link) <a href="http://www.juniv.edu/discussion/10732" target="_blank">
                            @endif
                            <img class="first-slide lazy img-fluid" src="{{ asset("storage/image/gallery/$image->path") }}"
                                alt="Banner Image">
...
<div class="container mb-2">
    <div class="row">
	 <div class="col-md-3 text-md-left text-center"> </div>
    <div class="col-md-2 text-md-right text-center pr-0">
            <img src="23-24.jpg" class="rounded" alt="" style="width: 235px;height: 84px; margin-top:15px;"> 
        </div>
        <div class="col-md-2 text-md-left text-center pr-0">
            <a href="https://bachelor.ju-admission.org" target="_blank"><img src="click-here-img.gif" class="rounded" alt="" style="width: 250px;height: 73px;margin-top:15px"></a>
        </div>
