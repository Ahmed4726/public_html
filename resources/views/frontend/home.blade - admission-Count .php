    ...
    <div class="row lg-links-left">
        ...
        <div class="col-lg-2">
            <ul class="list-unstyled">
                ...
                <li class="d-inline">
                    <a href="{{url('/page/mission-vision')}}" class="d-inline">
                        <div class="link-div">
...
<div class="container mb-2">
    <div class="row">
	 <div class="col-md-2 text-md-left text-center"> </div>
    <div class="col-md-2 text-md-right text-center pr-0">
            <img src="20-21.jpg" class="rounded" alt="" style="width: 235px;height: 84px; margin-top:15px;"> 
        </div>
        <div class="col-md-2 text-md-left text-center pr-0">
            <a href="https://juniv-admission.org/" target="_blank"><img src="apply-now-img.gif" class="rounded" alt="" style="width: 180px;height: 108px;margin-top:15px"></a>
        </div>

        <div class="col-md-4 text-md-left text-center"> <!-- https://codechi.com/dev-tools/date-to-millisecond-calculators/ -->
            <div id="countDownTimer" data-endtimeinmillis="1685552400000"
                style="display: inline-block; padding-top: 12px;">
                <div id="countdown">
                    <div id="tiles"><span>39</span><span>13</span><span>20</span><span>36</span></div>
                    <div class="labels">
                        <ul>
                            <li>Days</li>
                            <li>Hours</li>
                ...
                <style type="text/css">
                    ...
                    #countdown #tiles>span {
                        ...
                        position: relative;
                        text-shadow: 1px 1px 0px #79aa72;
                        border: 2px solid #79aa72;
                    }
