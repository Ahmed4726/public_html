...
<div class="container mb-2">
    ...
    <div class="col-md-4 text-md-right text-center pr-0">
            <img src="ju-conv.jpg" class="rounded" alt="" style="width: 280px;height: 100px; margin-top:0px;">
        </div>
        <div class="col-md-4 text-md-left text-center pr-0">
            <a href="https://convocation.juniv.edu" target="_blank"><img src="click-here-button.gif" class="rounded" alt="" style="width:auto;height: 90px"></a>
        </div>
        <div class="col-md-2 text-md-left text-center">
