...
<div class="container mb-2">
    ...
    <div class="col-md-2 text-md-right text-center pr-0">
            <img src="22-23-result.jpg" class="rounded" alt="" style="width: 235px;height: 84px; margin-top:15px;"> 
        </div>
        <div class="col-md-2 text-md-left text-center pr-0">
            <a href="https://juniv-admission.org/ju-admission-result" target="_blank"><img src="click-here-img.gif" class="rounded" alt="" style="width: 250px;height: 73px;margin-top:15px"></a>
        </div>
