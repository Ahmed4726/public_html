            ...
            <div class="row footer-links">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="no-style">
                        ...
                        <li><a href="{{$link->link_url}}" target="{{$link->target}}"><i
                                    class="fa fa-angle-double-right"></i> {{$link->label}}</a></li>
                        @endforeach
                    </ul>
                ...
                <div class="col-md-3">
                    ...
                    <row>
                        <div class="col-md-12 social-icons">
                            <a href="{{$setting->facebook_link}}"> <i class="fab fa-facebook-f" data-pack="social"
                                    data-tags="like, post, share"></i> </a>
                            <a href="{{$setting->twitter_link}}"> <i class="fab fa-twitter" data-pack="social"
                                    data-tags="like, post, share"></i> </a>
                            <a href="{{$setting->linkedin_link}}"> <i class="fab fa-linkedin-in" data-pack="social"
                                    data-tags="like, post, share"></i> </a>
                        </div>
                    </row>
