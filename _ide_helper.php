...
')
    ...
    namespace App\Utilitys\Facades { 
            /**
     * 
     *
     */ 
         ...
         *
         * @param \App\Utilitys\[type] $model
         * @param \App\Utilitys\[type] $status
         * @return object 
         * @static 
         */ 
        public static function allStatus($model, $status = false)
        {
                        /** @var \App\Utilitys\Helper $instance */
                        return $instance->allStatus($model, $status);
        }
                    /**
         * Generate Username for email
         *
         * @param \App\Utilitys\[type] $name
         * @param \App\Utilitys\[type] $session
         * @param integer $counter
         * @param integer $increment
         * @return void 
         * @static 
         */ 
        public static function userNameGenerator($name, $program, $session, $counter = 1, $increment = 2)
        {
                        /** @var \App\Utilitys\Helper $instance */
                        $instance->userNameGenerator($name, $program, $session, $counter, $increment);
        }
                    /**
         ...
         * @static 
         */ 
        public static function dateRangeTextToArray($rangeText)
        {
                        /** @var \App\Utilitys\Helper $instance */
                        return $instance->dateRangeTextToArray($rangeText);
        }
...
namespace  { 
            ...
            class Laralum extends \App\Http\Controllers\Laralum\Laralum {}
            class Image extends \Intervention\Image\Facades\Image {}
            class Agent extends \Jenssegers\Agent\Facades\Agent {}
            class Helper extends \App\Utilitys\Facades\Helper {}
