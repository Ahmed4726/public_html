...
Route::group(['as' => 'Frontend::'], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'faculty', 'namespace' => 'Laralum', 'as' => 'faculty::'], function () {
        ...
        Route::get('/events/{discussion}', 'FacultyController@facultyDiscussionView')->name('facultyEventview');
    });
...
//    Route::get('/image/banner', 'SettingsController@getAllBannerImage')->name('image::banner');
    ...
    // Start Faculty Event
    Route::get('/faculty/{faculty}/faculty_event_create', 'FacultyController@facultyEventCreate')->name('faculty::facultyEventCreate');
    Route::post('/faculty/faculty_event_create', 'FacultyController@facultyEventstore')->name('faculty::facultyEventstore');
    Route::get('/faculty/{faculty}/faculty_eventlist/{DiscussionID}', 'FacultyController@facultyEventDelete')->name('faculty::facultyEventDelete');
    Route::get('/faculty/{faculty}/faculty_eventlist/{DiscussionID}/edit', 'FacultyController@facultyEventEdit')->name('faculty::facultyEventEdit');
    Route::post('/faculty/{faculty}/faculty_eventlist/{DiscussionID}/edit', 'FacultyController@facultyEventupdate')->name('faculty::facultyEventupdate');
    Route::get('/faculty/{faculty}/faculty_eventlist', 'FacultyController@facultyEventlist')->name('faculty::facultyEventlist');
